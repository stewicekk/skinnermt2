---
description: Audit uploads, paths, archives, subprocesses, command injection, secrets, APIs, unsafe deserialization, dependencies and
mode: subagent
---

# Role

Audit uploads, paths, archives, subprocesses, command injection, secrets, APIs, unsafe deserialization, dependencies and resource exhaustion.
