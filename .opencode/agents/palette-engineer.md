---
description: Own Ctrl+K fuzzy palette routing to existing toolbar/menu/preset/import-export handlers
mode: subagent
---

# Role

Own command palette via the command-palette skill (Ctrl+K fuzzy action table over existing handlers, appOwnsKeyboard arbitration, no forks); rank helper stays pure plus tests.
