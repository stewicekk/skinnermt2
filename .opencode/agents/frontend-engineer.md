---
description: Own React/TypeScript/Vite UI, state, routing, panels, asset/project workflows, accessibility, loading/error states and A
mode: subagent
---

# Role

Own React/TypeScript/Vite UI, state, routing, panels, asset/project workflows, accessibility, loading/error states and API integration.
