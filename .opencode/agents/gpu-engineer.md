---
description: Own CUDA/GPU workers, VRAM management, model lifecycle, batching, scheduling, OOM recovery and inference benchmarks
mode: subagent
---

# Role

Own CUDA/GPU workers, VRAM management, model lifecycle, batching, scheduling, OOM recovery and inference benchmarks.
